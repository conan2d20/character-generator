...
export class Homelands {
  private _homeLands: { [id: number]: HomelandModel } = {
    [HomeLand.Aquilonia]: new HomelandModel(
      'Aquilonia',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Aquilonian'],
      7,
      Source.Core
    ),
    [HomeLand.BossonianMarches]: new HomelandModel(
      'Bossonian Marches',
      TalentsHelper.getTalent('Hunter'),
      ['Aquilonian'],
      9,
      Source.Core
    ),
    [HomeLand.Keshan]: new HomelandModel(
      'Keshan',
      TalentsHelper.getTalent('Savage Court'),
      ['Keshani'],
      10,
      Source.Core
    ),
    [HomeLand.Kush]: new HomelandModel('Kush', TalentsHelper.getTalent('Strife'), ['Kushite'], 11, Source.Core),
    [HomeLand.Khoraja]: new HomelandModel(
      'Khoraja',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Shemitish', 'Kothic'],
      12,
    ...
    [HomeLand.Cimmeria]: new HomelandModel(
      'Cimmeria',
      TalentsHelper.getTalent('Hunter'),
      ['Cimmerian'],
      13,
    ...
    [HomeLand.Hyperborea]: new HomelandModel(
      'Hyperborea',
      TalentsHelper.getTalent('Savage Court'),
      ['Hyperborean'],
      14,
    ...
    [HomeLand.BorderKingdom]: new HomelandModel(
      'Border Kingdom',
      TalentsHelper.getTalent('Strife'),
      ['Nemedian', 'Hyperborean'],
      15,
      Source.Core
    ),
    [HomeLand.Nordheim]: new HomelandModel(
      'Nordheim',
      TalentsHelper.getTalent('Winter-born'),
      ['Nordheimer'],
      16,
      Source.Core
    ),
    ...
    [HomeLand.Gunderland]: new HomelandModel(
      'Gunderland',
      TalentsHelper.getTalent('Hunter'),
      ['Aquilonian'],
      20,
    ...
    [HomeLand.Brythunia]: new HomelandModel(
      'Brythunia',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Brythunian'],
      21,
    ...
    [HomeLand.Nemedia]: new HomelandModel(
      'Nemedia',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Nemedian'],
      22,
    ...
    [HomeLand.Zamora]: new HomelandModel(
      'Zamora',
      TalentsHelper.getTalent('Honest Corruption'),
      ['Zamorian'],
      23,
      Source.Core
    ),
    [HomeLand.Shem]: new HomelandModel('Shem', TalentsHelper.getTalent('Strife'), ['Shemitish'], 24, Source.Core),
    [HomeLand.Zingara]: new HomelandModel(
      'Zingara',
      TalentsHelper.getTalent('Sea Raider'),
      ['Zingaran'],
      25,
      Source.Core
    ),
    [HomeLand.Corinthia]: new HomelandModel(
      'Corinthia',
      TalentsHelper.getTalent('Strife'),
      ['Corinthian'],
      26,
    ...
    [HomeLand.Stygia]: new HomelandModel(
      'Stygia',
      TalentsHelper.getTalent('Desert-born'),
      ['Stygian'],
      27,
      Source.Core
    ),
    [HomeLand.Khauran]: new HomelandModel(
      'Khauran',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Shemitish', 'Kothic'],
      28,
    ...
    [HomeLand.Zembabwei]: new HomelandModel(
      'Zembabwei',
      TalentsHelper.getTalent('Desert-born'),
      ['Zembabwein'],
      29,
    ...
    [HomeLand.TheBlackKingdoms]: new HomelandModel(
      'The Black Kingdoms',
      TalentsHelper.getTalent('Strife'),
      ['Kushite', 'Darfari', 'Keshani', 'Punt'],
      31,
      Source.Core
    ),
    [HomeLand.Darfar]: new HomelandModel(
      'Darfar',
      TalentsHelper.getTalent('Savage Court'),
      ['Darfari'],
      32,
    ...
    [HomeLand.Hyrkania]: new HomelandModel(
      'Hyrkania',
      TalentsHelper.getTalent('Of Saddle and Bow'),
      ['Hyrkanian'],
      36,
      Source.Core
    ),
    [HomeLand.Iranistan]: new HomelandModel(
      'Iranistan',
      TalentsHelper.getTalent('Desert-born'),
      ['Iranistani'],
      38,
    ...
    [HomeLand.Khitai]: new HomelandModel(
      'Khitai',
      TalentsHelper.getTalent('Savage Court'),
      ['Khitan'],
      40,
    ...
    [HomeLand.Yuetshi]: new HomelandModel(
      'Yuetshi',
      TalentsHelper.getTalent('Sea Raider'),
      ['Yuetshi'],
      99,
    ...
    [HomeLand.Zamboula]: new HomelandModel(
      'Zamboula',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Turanian', 'Shemitish'],
      99,
    ...
    [HomeLand.Zuagir]: new HomelandModel(
      'Zuagir',
      TalentsHelper.getTalent('Desert-born'),
      ['Zuagir'],
      99,
    ...
    [HomeLand.BarachaIsles]: new HomelandModel(
      'The Baracha Isles',
      TalentsHelper.getTalent('Sea Raider'),
      ['Argossean', 'Zingaran'],
      99,
    ...
    [HomeLand.BlackCoast]: new HomelandModel(
      'The Black Coast',
      TalentsHelper.getTalent('Strife'),
      ['Kushite', 'Keshan', 'Punt', 'Darfari'],
      99,
      Source.Pirate
    ),
    [HomeLand.Westermarck]: new HomelandModel(
      'Westermarck',
      TalentsHelper.getTalent('Hunter'),
      ['Aquilonian'],
      99,
    ...
    [HomeLand.Ghulistan]: new HomelandModel(
      'Ghulistan',
      TalentsHelper.getTalent('Desert-born'),
      ['Afghuli'],
      99,
    ...
    [HomeLand.Kosala]: new HomelandModel(
      'Kosala',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Kosalan'],
      99,
    ...
    [HomeLand.Kordafan]: new HomelandModel(
      'Kordafan',
      TalentsHelper.getTalent('Hunter'),
      ['Kordafani'],
      99,
    ...
    [HomeLand.Tombalku]: new HomelandModel(
      'Tombalku',
      TalentsHelper.getTalent('Honest Corruption'),
      ['Tombalkan'],
      99,
    ...
    [HomeLand.Xuchotl]: new HomelandModel(
      'Xuchotl',
      TalentsHelper.getTalent('Strife'),
      ['Xuchotli'],
      99,
    ...
    [HomeLand.IslesOfThePicts]: new HomelandModel(
      'Kaa-u, Isles of the Picts',
      TalentsHelper.getTalent('Savage Court'),
      ['Pictish'],
      5,
      Source.Kull
    ),
    [HomeLand.Commoria]: new HomelandModel(
      'Commoria',
      TalentsHelper.getTalent('Faded Glory'),
      ['Commorian'],
      8,
      Source.Kull
    ),
    [HomeLand.Thule]: new HomelandModel('Thule', TalentsHelper.getTalent('Decadent'), ['Thulian'], 10, Source.Kull),
    [HomeLand.Kamelia]: new HomelandModel(
      'Kamelia',
      TalentsHelper.getTalent('Decadent'),
      ['Kamelian'],
      13,
      Source.Kull
    ),
    [HomeLand.Valusia]: new HomelandModel(
      'Valusia',
      TalentsHelper.getTalent('Cosmopolitan'),
      ['Valusian'],
      21,
    ...
    [HomeLand.Farsun]: new HomelandModel(
      'Farsun',
      TalentsHelper.getTalent('Resplendent'),
      ['Old Tongue'],
      24,
      Source.Kull
    ),
    [HomeLand.Verulia]: new HomelandModel(
      'Verulia',
      TalentsHelper.getTalent('Treacherous'),
      ['Verulian'],
      27,
      Source.Kull
    ),
    [HomeLand.Zarfhaana]: new HomelandModel(
      'Zarfhaana',
      TalentsHelper.getTalent('Pastoral'),
      ['Lost Tongue'],
      30,
      Source.Kull
    ),
    [HomeLand.Thurania]: new HomelandModel(
      'Thurania',
      TalentsHelper.getTalent('Savage Court'),
      ['Lost Tongue'],
      33,
    ...
    [HomeLand.Grondar]: new HomelandModel(
      'Grondar',
      TalentsHelper.getTalent('Of Saddle and Bow'),
      ['Grond'],
      36,
    ...
    [HomeLand.Lemuria]: new HomelandModel(
      'Lemuria',
      TalentsHelper.getTalent('Sea Raider'),
      ['Lemurian'],
      38,
    ...
    [HomeLand.ElderStygia]: new HomelandModel(
      'Elder Stygia',
      TalentsHelper.getTalent('Desert-born'),
      ['Lost Tongue'],
      40,
  ...
  generateBrigandHomeland() {
    ...
    switch (Math.floor(Math.random() * 20) + 1) {
      ...
      case 11:
      case 12:
        homeland = HomeLand.Khauran;
        break;
      case 13:
        homeland = HomeLand.Yuetshi;
        break;
      case 14:
      case 15:
      case 16:
      case 17:
        homeland = HomeLand.Zamboula;
        break;
      case 18:
      case 19:
      case 20:
        homeland = HomeLand.Zuagir;
        break;
    }
  ...
  generatePirateHomeland() {
    ...
    switch (Math.floor(Math.random() * 20) + 1) {
      ...
      case 3:
      case 4:
        homeland = HomeLand.Argos;
        break;
      case 5:
      case 6:
      case 7:
      case 8:
        homeland = HomeLand.BarachaIsles;
        break;
      case 9:
      case 10:
      case 11:
        homeland = HomeLand.BlackCoast;
        break;
      case 12:
      case 13:
        homeland = HomeLand.Kush;
        break;
      case 14:
        homeland = HomeLand.Shem;
        break;
      case 15:
        homeland = HomeLand.Stygia;
        break;
      case 16:
        homeland = HomeLand.Nordheim;
        break;
      case 17:
      case 18:
      case 19:
      case 20:
        homeland = HomeLand.Zingara;
        break;
    }
  ...
  generateScoutHomeland() {
    ...
    switch (Math.floor(Math.random() * 20) + 1) {
      ...
      case 6:
      case 7:
        homeland = HomeLand.Aquilonia;
        break;
      case 8:
      case 9:
        homeland = HomeLand.BorderKingdom;
        break;
      case 10:
        homeland = HomeLand.BossonianMarches;
        break;
      case 11:
      case 12:
      case 13:
        homeland = HomeLand.Brythunia;
        break;
      case 14:
        homeland = HomeLand.Gunderland;
        break;
      case 15:
        homeland = HomeLand.Nemedia;
        break;
      case 16:
      case 17:
      case 18:
  ...
  generateEasternHomeland() {
    ...
    switch (Math.floor(Math.random() * 20) + 1) {
      case 1:
        homeland = HomeLand.Ghulistan;
        break;
      case 2:
      case 3:
      case 4:
      case 5:
        homeland = HomeLand.Iranistan;
        break;
      case 6:
      case 7:
      case 8:
      ...
      case 15:
      case 16:
        homeland = HomeLand.Khitai;
        break;
      case 17:
      case 18:
        homeland = HomeLand.Kosala;
        break;
      case 19:
      case 20:
        homeland = HomeLand.Vendhya;
        break;
    }
  ...
  generateSouthernHomeland() {
    ...
    switch (Math.floor(Math.random() * 20) + 1) {
      case 1:
      case 2:
        homeland = HomeLand.Darfar;
        break;
      case 3:
      case 4:
        homeland = HomeLand.Keshan;
        break;
      case 5:
      case 6:
        homeland = HomeLand.Kordafan;
        break;
      case 7:
      case 8:
        homeland = HomeLand.Kush;
      ...
      case 9:
      case 10:
        homeland = HomeLand.Punt;
        break;
      case 11:
      case 12:
        homeland = HomeLand.Tombalku;
        break;
      case 13:
      case 14:
        homeland = HomeLand.Zembabwei;
        break;
      case 15:
      case 16:
        homeland = HomeLand.TheBlackKingdoms;
        break;
      case 17:
      case 18:
      case 19:
  ...
  generateKullHomeland() {
    ...
    switch (d1 + d2) {
      case 2:
      case 3:
        homeland = HomeLand.Atlantis;
        break;
      case 4:
      case 5:
        homeland = HomeLand.IslesOfThePicts;
        break;
      case 6:
      case 7:
      case 8:
        homeland = HomeLand.Commoria;
        break;
      case 9:
      case 10:
        homeland = HomeLand.Thule;
        break;
      case 11:
      case 12:
      case 13:
        homeland = HomeLand.Kamelia;
        break;
      case 14:
      case 15:
      case 16:
      ...
      case 20:
      case 21:
        homeland = HomeLand.Valusia;
        break;
      case 22:
      case 23:
      case 24:
        homeland = HomeLand.Farsun;
        break;
      case 25:
      case 26:
      case 27:
        homeland = HomeLand.Verulia;
        break;
      case 28:
      case 29:
      case 30:
        homeland = HomeLand.Zarfhaana;
        break;
      case 31:
      case 32:
      case 33:
        homeland = HomeLand.Thurania;
        break;
      case 34:
      case 35:
      case 36:
        homeland = HomeLand.Grondar;
        break;
      case 37:
      case 38:
        homeland = HomeLand.Lemuria;
        break;
      case 39:
      case 40:
        homeland = HomeLand.ElderStygia;
        break;
    }
  ...
  getNameSuggestions(gender: Gender) {
    return gender === Gender.Male ? this._maleNames : this._femaleNames;
  }
