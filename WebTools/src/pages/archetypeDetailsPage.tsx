...
export class ArchetypeDetailsPage extends React.Component<IPageProperties, {}> {
    ...
    render() {
        ...
        const mandatory = archetype.mandatorySkills.map((s, i) => {
        ...
        if (character.useWeedOfSorcery) {
            veteranTalents.push(...TalentsHelper.getTalentsForSkills([Skill.Sorcery]).map(t => { return t.name; }));
        }
            ...
            character.archetype === Archetype.Veteran
                ...
                : !character.useWeedOfSorcery
                    ...
                    : <div>
                        <TalentSelection
                            onSelection={(talent) => { this.onTalentSelected(talent); } }
                            talents={[archetype.careerTalent.name, ...TalentsHelper.getTalentsForSkills([Skill.Sorcery]).map(t => { return t.name; })]}  />
                      </div>;
        ...
        return (
            <div className="page">
                ...
                <div className="panel">
                    ...
                    <ElectiveSkillList skills={archetype.electiveSkills} onUpdated={skills => this.onElectivSkillsUpdated(skills) } />
                </div>
                <div className="panel">
    ...
    private updateKits() {
        if (character.archetype !== Archetype.Priest &&
