    ...
    render() {
        ...
        var content = !this.state.showSelection ?
            (
                <div>
                    <div className="page-text">
                        ...
                        Literacy is rare and most of what is learned comes at the steep price of experience.
                        Those who are lucky will enjoy what they are taught by their parents, or will be able
                        to find a mentor or tutor able to educate them properly about the world.
                        <br /><br />
                        Your Education gives you skills and a talent; and can only be rolled unless your GM
            ...
            : (
                <div>
                    <EducationSelection
                        onSelection={(edu) => this.selectEducation(edu) }
