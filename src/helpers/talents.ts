...
class VariableHomelandPrerequisite implements ITalentPrerequisite {
  ...
  isPrerequisiteFulfilled() {
    return character.homeland === this.homeland1 || character.homeland === this.homeland2;
  }
...
class WeedOfSorceryPrerequisite implements ITalentPrerequisite {
  ...
  isPrerequisiteFulfilled() {
    return character.useWeedOfSorcery || character.skills[Skill.Sorcery].expertise >= this.expertise;
  }
...
export class TalentViewModel {
  ...
  constructor(name: string, rank: number, showRank: boolean, description: string, skill: Skill) {
    ...
    this.name =
      name +
      (showRank ? ' [Rank: ' + rank + ']' : '') +
      (skill !== Skill.None ? ' (' + SkillsHelper.getSkillName(skill) + ')' : '');
  }
}
  ...
  private _talents: { [skill: number]: TalentModel[] } = {
    [Skill.Acrobatics]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Deck Rat'),
          new TalentPrerequisite('Nimble as a Cat'),
    ...
    [Skill.Animal_Handling]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Eyes in the Forest'),
          new ExpertisePrerequisite(Skill.Animal_Handling, 2),
          new SourcePrerequisite(Source.Scout),
        ],
        3
      ),
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Faithful Companion'),
          new ExpertisePrerequisite(Skill.Animal_Handling, 3),
          new SourcePrerequisite(Source.Scout),
        ],
        3
      ),
    ...
    [Skill.Athletics]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Pugilist'),
          new ExpertisePrerequisite(Skill.Athletics, 2),
          new FocusPrerequisite(Skill.Melee, 2),
        ],
        1
      ),
      new TalentModel(
    ...
    [Skill.Discipline]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Iron Will'),
          new ExpertisePrerequisite(Skill.Discipline, 3),
          new SourcePrerequisite(Source.Barbarian),
        ],
        1
      ),
      new TalentModel(
    ...
    [Skill.Healing]: [
      ...
      new TalentModel(
        ...
        [
          new FocusPrerequisite(Skill.Healing, 2),
          new FocusPrerequisite(Skill.Survival, 2),
          new SourcePrerequisite(Source.Skelos),
        ],
        3
      ),
    ],
    ...
    [Skill.Melee]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Grappler'),
          new ExpertisePrerequisite(Skill.Melee, 2),
          new ExpertisePrerequisite(Skill.Persuade, 2),
          new SourcePrerequisite(Source.Barbarian),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new VariableHomelandPrerequisite(0, 12),
          new TalentPrerequisite('No Mercy'),
          new ExpertisePrerequisite(Skill.Melee, 2),
          new ExpertisePrerequisite(Skill.Parry, 2),
          new SourcePrerequisite(Source.Scout),
        ],
        1
      ),
    ...
    [Skill.Parry]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Deflection'),
          new ExpertisePrerequisite(Skill.Parry, 3),
          new SourcePrerequisite(Source.Barbarian),
        ],
        1
      ),
    ...
    [Skill.Persuade]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Chicanery'),
    ...
    [Skill.Ranged_Weapons]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Marksman'),
          new ExpertisePrerequisite(Skill.Ranged_Weapons, 3),
          new SourcePrerequisite(Source.Scout),
        ],
        3
      ),
    ...
    [Skill.Sorcery]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Necromancer'),
          new UniqueTalentPrerequisite('Skinwalker'),
          new SourcePrerequisite(Source.Skelos),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          ...
          new TalentPrerequisite('Iron Will'),
          new TalentPrerequisite('Jaded'),
          new VariableTalentPrerequisite('Necromancer', 'Sorcerer'),
          new SourcePrerequisite(Source.Skelos),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Patron'),
          new ExpertisePrerequisite(Skill.Discipline, 2),
          new SourcePrerequisite(Source.Skelos),
        ],
        3
      ),
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Mesmerist'),
          new FocusPrerequisite(Skill.Discipline, 4),
          new AttributePrerequisite(Attribute.Willpower, 11),
          new SourcePrerequisite(Source.Skelos),
        ],
        3
      ),
    ...
    [Skill.Stealth]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Obscure Trail'),
          new ExpertisePrerequisite(Skill.Stealth, 3),
          new ExpertisePrerequisite(Skill.Survival, 3),
          new SourcePrerequisite(Source.Scout),
        ],
        3
      ),
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Living Shadow'),
          new FocusPrerequisite(Skill.Stealth, 3),
          new SourcePrerequisite(Source.Scout),
        ],
        1
      ),
    ...
    [Skill.Thievery]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Journeyman'),
          new TalentPrerequisite('Master Thief'),
          new SourcePrerequisite(Source.Thief),
        ],
        1
      ),
      new TalentModel(
    ...
    [Skill.None]: [
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new VariableHomelandPrerequisite(3, 23),
          new SourcePrerequisite(Source.Pirate),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandPrerequisite(8),
          new RegionPrerequisite('Vanaheim'),
          new SourcePrerequisite(Source.Pirate),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([0, 1, 12, 35]),
          new SourcePrerequisite(Source.Scout),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([24, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([2, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([38, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([3, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([22, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      ...
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([39, 40]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new AncientBloodlinePrerequisite(),
          new HomelandsPrerequisite([21, 39]),
          new SourcePrerequisite(Source.Adventurer),
        ],
        1
      ),
    ...
    [Skill.Berserk]: [
      ...
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Fierce Visage'),
          new TalentPrerequisite('War-shirt'),
          new TalentPrerequisite("With the Wolf's Eyes"),
          new SourcePrerequisite(Source.Barbarian),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new TalentPrerequisite('Courage of the Bear'),
          new ExpertisePrerequisite(Skill.Craft, 1),
          new ExpertisePrerequisite(Skill.Survival, 3),
          new SourcePrerequisite(Source.Barbarian),
        ],
    ...
    [Skill.Outlaw]: [
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Brigand),
          new TalentPrerequisite('Hidden Road'),
          new FocusPrerequisite(Skill.Command, 1),
        ],
        1
      ),
      new TalentModel(
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Brigand),
          new AnyTalentsPrerequisite(2, ['Brigand Band', 'Infamous Band', 'Invisible Army', 'Lair']),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Brigand),
          new TalentPrerequisite('Brigand Band'),
          new ExpertisePrerequisite(Skill.Command, 2),
          new ExpertisePrerequisite(Skill.Siegecraft, 2),
        ],
        1
      ),
      new TalentModel(
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Brigand),
          new ExpertisePrerequisite(Skill.Thievery, 2),
          new ExpertisePrerequisite(Skill.Stealth, 2),
          new ExpertisePrerequisite(Skill.Survival, 2),
        ],
        5
      ),
      new TalentModel(
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Brigand),
          new TalentPrerequisite('Bolt-hole'),
          new TalentRankPrerequisite('Lair', 2),
          new FocusPrerequisite(Skill.Survival, 2),
          new FocusPrerequisite(Skill.Stealth, 2),
          new FocusPrerequisite(Skill.Thievery, 2),
        ],
        1
      ),
    ],
    [Skill.Falconry]: [
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Mighty Bird'),
          new ExpertisePrerequisite(Skill.Animal_Handling, 3),
          new ExpertisePrerequisite(Skill.Melee, 1),
        ],
        2
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('My Eyes Above'),
          new ExpertisePrerequisite(Skill.Animal_Handling, 2),
          new ExpertisePrerequisite(Skill.Melee, 1),
        ],
        1
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('The Hunt'),
          new ExpertisePrerequisite(Skill.Animal_Handling, 2),
          new ExpertisePrerequisite(Skill.Society, 1),
        ],
        1
    ...
    [Skill.MartialArts]: [
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Open Hand'),
          new ExpertisePrerequisite(Skill.Parry, 2),
        ],
        2
      ),
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Symphony of Blades'),
          new TalentPrerequisite('Body of Flowing Water'),
        ],
        1
      ),
      new TalentModel(
    ...
    [Skill.Philosophy]: [
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Healthy Optimism'),
          new TalentPrerequisite('Metaphysics and Mysteries'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Know Thyself'),
          new ExpertisePrerequisite(Skill.Counsel, 3),
        ],
        1
      ),
      new TalentModel(
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Know Thyself'),
          new FocusPrerequisite(Skill.Discipline, 2),
          new ExpertisePrerequisite(Skill.Sorcery, 1),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Wanderer),
          new TalentPrerequisite('Know Thyself'),
          new FocusPrerequisite(Skill.Command, 2),
          new ExpertisePrerequisite(Skill.Persuade, 1),
        ],
        1
      ),
    ...
    [Skill.Griot]: [
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Adventurer),
          new UniqueTalentPrerequisite("Sky God's Stories"),
          new UniqueTalentPrerequisite('Salt of the River'),
          new TalentPrerequisite('Griot'),
        ],
        1
      ),
      new TalentModel(
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Adventurer),
          new UniqueTalentPrerequisite('Golden Words'),
          new UniqueTalentPrerequisite('Salt of the River'),
          new TalentPrerequisite('Griot'),
        ],
        2
    ...
    [Skill.Adherent]: [
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Exiles),
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Derketo'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          ...
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Jhebbal Sag'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          ...
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Mitra'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          ...
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Set'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          ...
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Ymir'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          ...
          new ExpertisePrerequisite(Skill.Alchemy, 1),
          new ExpertisePrerequisite(Skill.Counsel, 2),
          new TalentPrerequisite('Lay Worshipper: Yog'),
        ],
        1
      ),
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Exiles),
          new ExpertisePrerequisite(Skill.Craft, 2),
          new ExpertisePrerequisite(Skill.Discipline, 1),
          new TalentPrerequisite('Lay Worshipper: Derketo'),
        ],
        1
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Exiles),
          new AnyTalentsPrerequisite(2, [
            'Blesings and Unguents: Derketo',
            'Ceremonial Blade: Derketo',
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Exiles),
          new AnyTalentsPrerequisite(2, [
            'Blesings and Unguents: Jhebbal Sag',
            'Ceremonial Blade: Jhebbal Sag',
      ...
      new TalentModel(
        ...
        [
          new SourcePrerequisite(Source.Exiles),
          new FocusPrerequisite(Skill.Alchemy, 2),
          new FocusPrerequisite(Skill.Craft, 2),
          new TalentPrerequisite('Lay Worshipper: Derketo'),
        ],
        1
      ),
    ...
    skills.forEach((s, i) => {
      for (var i = 0; i < this._talents[s].length; i++) {
        ...
        if (include) {
          ...
          if (include) {
            var rank = character.hasTalent(talent.name) ? character.talents[talent.name].rank + 1 : 1;
