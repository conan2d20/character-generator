...
export class TalentAndLanguagesPage extends React.Component<IPageProperties, {}> {
    ...
    constructor(props: IPageProperties) {
        ...
        const talents = TalentsHelper.getTalentsForSkills([...SkillsHelper.getSkills(), Skill.Bard, Skill.Berserk, Skill.Adherent, Skill.Falconry, Skill.Griot, Skill.MartialArts, Skill.Philosophy, Skill.Outlaw]);
        ...
        const bloodline = character.ancientBloodline
            ? (
                <div className="panel">
                    ...
                    <TalentDescription
                        name={this._bloodline}
                        description={this._bloodlineDesc}/>
                </div>
              )
            : undefined;
        ...
        return (
            <div className="page">
                <div className="page-text">
                    Select a talent and additional languages.
                </div>
                <div className="panel">
