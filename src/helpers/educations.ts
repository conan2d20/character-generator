...
import { ArmorType, EquipmentHelper, WeaponType } from './equipment';
...
export class Educations {
  ...
  private _educations: { [id: number]: EducationModel } = {
    ...
    [Education.EducatedOnTheBattlefield]: new EducationModel(
      ...
      [
        EquipmentHelper.getWeaponsNotOfType(WeaponType.Missile),
        this.BattlefieldHonor + 'Helmet (Armor 3: Head; Heavy)',
      ],
      6,
      Source.Core
    ),
    ...
    [Education.Burglar]: new EducationModel(
      ...
      [`${Math.max(DiceRoller.rollSpecial(1, 0).hits, 1)} extra Gold`, 'Pry bar', 'Lockpicks'],
      104,
      Source.Thief
    ),
    ...
    [Education.Spider]: new EducationModel(
      ...
      ['Fine set of clothing', 'Fake documents or badge of office', 'Contacts high and low'],
      114,
      Source.Thief
    ),
    [Education.Bandit]: new EducationModel(
      ...
      ['Wineskin and dried meat', 'Heavy cloak', 'Walking staff'],
      116,
      Source.Thief
    ),
    [Education.QuackPhysician]: new EducationModel(
      ...
      [`${Math.max(DiceRoller.rollSpecial(2, 0).hits, 1)} extra Gold`, "Healer's kit", '4 bottles of false cures'],
      118,
      Source.Thief
    ),
    ...
    [Education.EducatedByTheEnemy]: new EducationModel(
      ...
      ['Writing implements', 'Religious icon of Mitra'],
      299,
      Source.Barbarian
    ),
    ...
    [Education.OnTheFarm]: new EducationModel(
      ...
      ['Sling bag of farm tools', 'One week’s worth of dried food', 'Clay bottle of home-made liquor'],
      99,
      Source.Scout
    ),
    [Education.SentToTheCity]: new EducationModel(
      ...
      ['Pouch containing 5 Gold', 'Fine garments', 'Letter of introduction from your mentor'],
      99,
      Source.Scout
    ),
    ...
    [Education.OnTheBackOfAHorse]: new EducationModel(
      ...
      ['Hyrkanian Bow', EquipmentHelper.getOneHandedWeapons('sword'), 'Fleet riding horse'],
      1008,
      Source.Wanderer
    ),
    [Education.ProfessionalSoldiering]: new EducationModel(
      ...
      [EquipmentHelper.getAllWeapons() + EquipmentHelper.getShields(), EquipmentHelper.getAllArmor()],
      1010,
      Source.Wanderer
    ),
    ...
    [Education.ShamanicTradition]: new EducationModel(
      ...
      ['Fetishes associated with your beliefs', 'Herbs and other elements for tinctures and concoctions'],
      1016,
      Source.Wanderer
    ),
    [Education.TheWisdomOfElders]: new EducationModel(
      ...
      ['Hyrkanian Bow', EquipmentHelper.getOneHandedWeapons('sword')],
      1018,
      Source.Wanderer
    ),
