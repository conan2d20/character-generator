            ...
            <div className="page">
                ...
                <table className="selection-list">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <DieRoll roll={this._dice[0]} index={0} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 0} />
                                <DieRoll roll={this._dice[1]} index={1} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 1} />
                            </td>
                            <td>{HomelandsHelper.getHomeland(HomelandsHelper.getHomelandForRoll(this._dice[0] + this._dice[1])).name}</td>
                        </tr>
                        <tr style={{ backgroundColor: "#5f643e", color: "white" }}>
                            <td></td>
                            <td><b>Attribute Aspects</b></td>
                        </tr>
                        <tr>
                            <td><DieRoll roll={this._dice[2]} index={2} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 2} /></td>
                            <td>{AttributesHelper.getAttributeAspect(AttributesHelper.getAttributeAspectForRoll(this._dice[2], Source.Core)).name}</td>
                        </tr>
                        <tr>
                            <td><DieRoll roll={this._dice[3]} index={3} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 3} /></td>
                            <td>{AttributesHelper.getAttributeAspect(AttributesHelper.getAttributeAspectForRoll(this._dice[3], Source.Core)).name}</td>
                        </tr>
                        <tr style={{ backgroundColor: "#5f643e", color: "white" }}>
                            <td></td>
                            <td><b>Caste</b></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[4]} index={4} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 4} /></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[5]} index={5} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 5} /></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[6]} index={6} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 6} /></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[7]} index={7} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 7} /></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[8]} index={8} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 8} /></td>
                        ...
                        <tr>
                            <td><DieRoll roll={this._dice[9]} index={9} onSelect={(index) => this.selectDie(index) } isSelected={this._selected === 9} /></td>
