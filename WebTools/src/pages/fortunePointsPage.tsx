        ...
        return (
            <div className="page">
                <div className="page-text">
                    Your start the game with <b>3</b> Fortune points.You can <b>permanently sacrifice</b> one Fortune point
                    to improve either an attribute or a skill.
                </div>
                <div className="panel">
                    <div className="header-small">ATTRIBUTES & SKILLS</div>
                    <div>
                        Improve one attribute by +1 or one skill by +2 Expertise/Focus.
                    </div>
