    ...
    render() {
        ...
        var content = !this.state.showSelection ?
            (
                <div>
                    <div className="page-text">
                        Caste is the social class from which the character was born and/or has emerged.
                        Generally, this will have been the character’s class since birth, though occasionally
                        nobles get enslaved and barbarians become kings and queens.
                        <br /><br />
            ...
            : (
                <div>
                    <CasteSelection
                        onSelection={(caste) => this.selectCaste(caste) }
                        onCancel={() => this.hideCastes() } />
                </div>
            );
