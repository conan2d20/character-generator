...
export class WarStories {
  private _warStories: WarStoryModel[] = [
    ...
    new WarStoryModel(
      "Performed as 'Angry Drunk' and 'Out of Control Lover' While Robbing Tavern Folk",
      [Skill.Parry, Skill.Persuade],
      114
    ),
    ...
    new WarStoryModel(
      'Planned and Executed Several Thefts with Skill and Precision',
      [Skill.Stealth, Skill.Thievery],
      120
    ),
    // Barbarian
