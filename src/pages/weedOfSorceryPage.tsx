        ...
        return (
            <div className="page">
                <div className="page-text">
                    You can now opt to exchange your talents from Archetype, Nature, Education and Customization for Sorcery talents. If you are not
                    interested in creating a practicing sorcerer, or if your GM does not allow it, skip this step.
                </div>
