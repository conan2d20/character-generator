...
export class WarStoryPage extends React.Component<IPageProperties, IWarStoryPageState> {
    ...
    constructor(props: IPageProperties) {
        ...
        this._descriptions = {
            [Source.Core]: "War is a constant throughout the Hyborian kingdoms, a battle of kings and chieftains, empires and armies. Everyone, including your character, has likely encountered war in one form or another, or some sort of conflict that proved instrumental in their current fate. For some, it is their most fearsome encounter or adventure to date, while for others, it is merely the latest in a string of harrowing experiences.",
            [Source.Thief]: "Thieves usually have heists of note, particularly big scores that they are known for and helped shape their worldviews.",
            [Source.Barbarian]: "War is a constant throughout the Hyborian kingdoms, a battle of kings and chieftains, empires and armies. Everyone, including your character, has likely encountered war in one form or another, or some sort of conflict that proved instrumental in their current fate. For some, it is their most fearsome encounter or adventure to date, while for others, it is merely the latest in a string of harrowing experiences.",
            [Source.Skelos]: "Sorcerers often have different stories than that of regular folk.",
            [Source.Mercenary]: "Mercenaries are as much about the tales they tell as the deeds they have done. A mercenary character will often embellish their tales.",
            [Source.Pirate]: "These tales are either the most notable experience your character has had, or the event that sent them onto the road of the pirate.",
            [Source.Cults]: "These events reflect the more unusual experiences that those deeply enmeshed within a committed, religious community might have.",
            [Source.Brigand]: "If you were not born into the ranks of the Zuagir, or raised as a kozaki, what turned you into a brigand? As a career, it isn’t the most likely of options for the average person. Something in your past turned you from what you were, to what you are now.",
            [Source.Beastmasters]: "Characters oriented towards the animal kingdom would have experienced a hunting story rather than a war story.",
            [Source.Scout]: "Life on the frontier is filled with danger and hard work. What kind of significant event did you experience?",
    ...
    render() {
        if (this.state.showOptions) {
            ...
            return (
                <div className="page">
                    <div className="page-text">
                        Select the type of notable event that your character has encountered.
                        The available options are dependent on the sources you have selected.
                    </div>
                    <div>
            ...
            const select = character.creationMode !== CreationMode.Random
