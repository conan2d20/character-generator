...
class NatureModel {
    ...
    constructor(name: string, description: string, attr: Attribute, mandatory: Skill[], elective: Skill[], talents: Skill[], roll: number, source: Source) {
        this.name = name;
...
export class NatureViewModel extends NatureModel {
    ...
    constructor(id: Nature, base: NatureModel) {
        super(base.name, base.description, base.attribute, base.mandatory, base.elective, base.talentSkills, base.roll, base.source);
        this.id = id;
    }
}
...
export class Natures {
    ...
    private generateSorcerousNature(roll: number) {
        switch (roll) {
            case 1:
            case 2: return Nature.Inspirational;
            case 3:
            case 4: return Nature.Learned;
            case 5:
            case 6: return Nature.Sneaky;
            case 7:
            case 8: return Nature.Scheming;
            case 9:
            case 10: return Nature.Curious;
            case 11:
            case 12: return Nature.Practical;
            case 13:
            case 14: return Nature.UnholyBirth;
            case 15:
            case 16: return Nature.Cursed;
            case 17:
            case 18: return Nature.Academic;
            case 19:
            case 20: return Nature.Driven;
        }
    ...
    private generatePirateNature(roll: number) {
        switch (roll) {
            case 1:
            case 2: return Nature.Bloodthirsty;
            case 3:
            case 4: return Nature.Craven;
            case 5:
            case 6: return Nature.Egotistical;
            case 7:
            case 8: return Nature.Greedy;
            case 9:
            case 10: return Nature.Gregarious;
            case 11:
            case 12: return Nature.Lustful;
            case 13:
            case 14: return Nature.Reckless;
            case 15:
            case 16: return Nature.Remorseless;
            case 17:
            case 18: return Nature.Ruthless;
            case 19:
            case 20: return Nature.Vain;
        }
