    ...
    render() {
        const modes = CreationModesHelper.getModes().map((mode, i) => {
            return (
                <tr key={i}>
                    ...
                    <td><Button text="SELECT" className="button-small" onClick={() => this.selectMode(mode.id) }/></td>
                </tr>
            );
        });
        ...
        return (
            <div className="page">
                ...
                <div>
                    <div className="source-action" onClick={() => { this.selectSources(true); } }>Select all</div>
                    <div className="source-action">|</div>
                    <div className="source-action" onClick={() => { this.selectSources(false); }}>Select none</div>
                </div>
                <br/>
                ...
                <div>
                    ...
                    <div className="source-select">
                        <CheckBox value={1} onChanged={val => this.onUseWeedOfSorceryChanged()} isChecked={character.useWeedOfSorcery} />
                    </div>
                    <div className="source-name">Use <i>Weed of Sorcery</i> rule (Core Book, page 44)</div>
                </div>
                <br/>
