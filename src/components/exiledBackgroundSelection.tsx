        ...
        var bgs = ExiledBackgroundHelper.getBackgrounds().map((b, i) => {
            return (
                <tr key={i}>
                    ...
                    <td>{AttributesHelper.getAttributeName(b.reduction[0])}/{AttributesHelper.getAttributeName(b.reduction[1])} </td>
                    <td><Button className="button-small" text="Select" onClick={() => { this.props.onSelection(b.id) }} /></td>
                </tr>
            )
        });
            ...
            <div>
                ...
                <table className="selection-list">
                    <thead>
                        <tr>
                            <td></td>
                            <td><b>Skill Bonus</b></td>
                            <td><b>Lost Attribute</b></td>
                            <td></td>
                        </tr>
                    </thead>
                    <tbody>
