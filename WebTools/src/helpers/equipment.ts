...
export class Equipment {
    private _armor: Item[] = [
        new Item("Helmet (Armor 3: Head; Heavy)", "Helmet", ItemType.Armor,
            {
                head: 3, arms: 0, torso: 0, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: ["Heavy"]
            }),
        ...
        new Item("Padded gambeson and trousers (Armor 1: Torso/Arms/Legs)", "Padded gambeson and trousers", ItemType.Armor,
            {
                head: 0, arms: 1, torso: 1, legs: 1, armorType: ArmorType.HeavyClothing,
                qualities: [""]
            }),
        new Item("Mail vest (Armor 3: Torso; Noisy)", "Mail vest", ItemType.Armor,
            {
                head: 0, arms: 0, torso: 3, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: ["Noisy"]
            }),
        new Item("Brigandine vest and trousers (Armor 2: Torso/Legs)", "Brigandine vest and trousers", ItemType.Armor,
            {
                head: 0, arms: 0, torso: 2, legs: 2, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        ...
        new Item("Mail vest (Armor 3: Torso; Noisy) and a helmet (Armor 3: Head; Heavy)", "Mail vest and helmet", ItemType.Armor,
            {
                head: 3, arms: 0, torso: 3, legs: 0, armorType: ArmorType.HeavyArmor,
        ...
        new Item("Suit of mail armor (Armor 3: all locations; Noisy)", "Suit of mail armor", ItemType.Armor,
            {
                head: 3, arms: 3, torso: 3, legs: 3, armorType: ArmorType.HeavyArmor,
                qualities: ["Noisy"]
            }),
        new Item("Brigandine long coat (Armor 2: Torso/Arms/Legs) with helmet (Armor 3: Head; Heavy)", "Brigandine long coat with helmet", ItemType.Armor,
            {
                head: 3, arms: 2, torso: 2, legs: 2, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        ...
        new Item("Mail shirt (Armor 3: Torso/Arms; Noisy)", "Mail shirt", ItemType.Armor,
            {
                head: 0, arms: 3, torso: 3, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: ["Noisy"]
            }),
        new Item("Padded jerkin (Armor 1: Torso/Arms)", "Padded jerkin", ItemType.Armor,
            {
                head: 0, arms: 1, torso: 1, legs: 0, armorType: ArmorType.HeavyClothing,
                qualities: [""]
            }),
        ...
        new Item("Brigandine jacket (Armor 2: Torso/Arms)", "Brigandine jacket", ItemType.Armor,
            {
                head: 0, arms: 2, torso: 2, legs: 0, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        new Item("Toughened leather jacket (Armor 1: Torso/Arms)", "Toughened leather jacket", ItemType.Armor,
            {
                head: 0, arms: 1, torso: 1, legs: 0, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        new Item("Heavy cape (Armor 1: Torso/Legs)", "Heavy cape", ItemType.Armor,
            {
                head: 0, arms: 0, torso: 1, legs: 1, armorType: ArmorType.HeavyClothing,
                qualities: [""]
            }),
        new Item("Heavy clothing and brigandine vest (Armor 3: Torso)", "Heavy clothing and brigandine vest", ItemType.Armor,
            {
                head: 0, arms: 0, torso: 3, legs: 0, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        new Item("Warm hooded cloak and leather cloaks and furs (Armor: 1; Torso/Arms/Legs)", "Warm hooded cloak and leather cloaks and furs", ItemType.Armor,
            {
                head: 0, arms: 1, torso: 1, legs: 1, armorType: ArmorType.LightArmor,
                qualities: [""]
            }),
        ...
        new Item("Mail hauberk with coif (Armor 3: Head/Arms/Torso; Heavy)", "Mail hauberk with coif", ItemType.Armor,
            {
                head: 3, arms: 3, torso: 3, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: ["Heavy"]
            }),
        new Item("Brigandine vest (Armor 2: Torso) and helmet (Armor 3: Head; Heavy)", "Brigandine vest and helmet", ItemType.Armor,
            {
                head: 3, arms: 0, torso: 2, legs: 0, armorType: ArmorType.LightArmor,
                qualities: ["Heavy"]
            }),
        new Item("Heavy Hauberk (Armor 3: Torso/Arms/Legs; Heavy)", "Heavy Hauberk", ItemType.Armor,
            {
                head: 0, arms: 3, torso: 3, legs: 3, armorType: ArmorType.HeavyArmor,
                qualities: ["Heavy"]
            }),
        ...
        new Item("Heavy Sleeves (Armor 3: Arms; Noisy)", "Heavy Sleeves", ItemType.Armor,
            {
                head: 0, arms: 3, torso: 0, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: ["Noisy"]
            }),
        new Item("Heavy Leggings (Armor 3: Legs; Noisy)", "Heavy Leggings", ItemType.Armor,
            {
                head: 0, arms: 0, torso: 0, legs: 3, armorType: ArmorType.HeavyArmor,
                qualities: ["Noisy"]
            }),
        ...
        new Item("Armored breastplate(Armor 4: Torso) and helmet(Armor 3: Head)", "Armored breastplate", ItemType.Armor,
            {
                head: 3, arms: 0, torso: 4, legs: 0, armorType: ArmorType.HeavyArmor,
                qualities: []
            }),
    ...
    private _kits: { [skill: number]: string } = {
        ...
        [Skill.Stealth]: "Makeup and Scent Oils|Appropriate clothing for disguises|Wardrobe of appropriate clothing for disguises",
    ...
    getBelongings(source: Source) {
        return this._belongings.sort((a, b) => { return a.localeCompare(b); });
    }

    getGarments(source: Source) {
        return this._garments.sort((a, b) => { return a.localeCompare(b); });
    }

    getProvenanceWeapons(source: Source) {
        return this._provenanceWeapons.sort((a, b) => { return a.localeCompare(b); });
    }

    getProvenances(source: Source) {
        return this._provenances.sort((a, b) => { return a.localeCompare(b); });
    }
    ...
    getOneHandedWeapons(nameFilter?: string) {
        ...
        for (var i = 0; i < this._weapons.length; i++) {
            ...
            if ((weapon.properties as IWeaponProperties).size === WeaponSize.OneHanded) {
                ...
                if (nameFilter) {
                    if ((weapon.properties as IWeaponProperties).weaponType.toString().toLowerCase() !==  nameFilter.toLocaleLowerCase()) {
                        add = false;
                    }
                }
    ...
    getShields(): string {
        ...
        return this.arrayToString(shields.sort((a, b) => { return a.localeCompare(b) }));
    }
    ...
    getAllArmor(): string {
        ...
        return this.arrayToString(armors.sort((a, b) => { return a.localeCompare(b) }));
    }
